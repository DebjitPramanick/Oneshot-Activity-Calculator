const labelsData = {
    ...
    outputLabels: {
        ...
        opportunities_label: 'No. of opportunities you should have:',
        meetings_label: 'No. of meetings you should have: ',
        leads_label: 'No. of leads you should have to contact: ',
        emails_label: 'No. of emails you should have to personalize and research: ',
    }
}
